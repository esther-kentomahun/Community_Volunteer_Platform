...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        if (isLoginTab) {
            ...
            if (!existingUserRaw) {
                alert("Account not found. please switch to the 'Create Account' tab to sign up first!");
                return;
            }
            ...
            if (UserData.role === "volunteer") {
                ...
                alert(`Welcome back, ${firstName}! Redirecting to volunteer Dashboard...`);
            } else {
                alert(`Welcome back, ${UserData.name}! Redirecting to your NGO Dashboard...`);
            }
        } else {
            ...
            if (existingEmail) {
               alert("This email is already registered. Please switch to the 'Login' tab.");
               return 
            }
           ...
           <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl shadow-xl p-8 relative z-10">
              {/*header text*/}
               <div className="text-center  mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                      {isLoginTab? "Sign Up or Login to make an impact.":"Get started by filling in your details."}
                   </p>
               </div>
               {/*Tab switcher*/}
                        ...
                        <div className="w-full flex flex-col text-left">
                           ...
                           <div className="relative w-full">
                                <input type="text"
                                    ...
                                    placeholder={
                                    userRole === "volunteer" ? "Enter your full name" : "Enter your organization name"}
                        ...
                        <div className="w-full flex flex-col mt-2">
                           ...
                           <div className="grid grid-cols-2 gap-3 w-full">
                               ...
                               <button type="button"
                                    ...
                                    userRole === "volunteer"? "border-blue-600 bg-blue-50 text-blue-700 font-semibold ring-1 ring-blue-600"
                                    : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}>👤 A Volunteer
                               </button>
                                {/* NGO / Organization Option Button */}
                                <button type="button"
                                    onClick={() => setUserRole("ngo")}
                                    className={`flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border text-sm font-medium transition-all cursor-pointer ${
                                    userRole === "ngo"? "border-blue-600 bg-blue-50 text-blue-700 font-semibold ring-1 ring-blue-600"
                                    : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}>🏢 An NGO / Organization
                                </button>
                            </div>
                       </div>
                   )}
              ...
              <div className="w-full flex flex-col items-center mt-6">
                  <div className="relative w-full flex items-center justify-center my-2">
                      ...
                      <span className="relative bg-white px-3 text-[10px] font-bold tracking-wider text-gray-600 uppercase z-10">OR CONTINUE WITH</span>
                  </div>
